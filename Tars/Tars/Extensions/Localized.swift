...
struct LocalizableStrings {
    ...
    static let airPodsInstructions = NSLocalizedString("제대로 우주 공간을 경험하기 위해서는 반드시 에어팟을 착용해주세요", comment: "")
}

enum PlanetStrings: String {
    case jupiter, jupiterContent, airPodsInstructions
    ...
    var localizedKey: String {
        ...
        case .airPodsInstructions:
            return LocalizableStrings.airPodsInstructions
        }
    }
}
