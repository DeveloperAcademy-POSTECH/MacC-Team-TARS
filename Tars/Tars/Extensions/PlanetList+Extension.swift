...
extension PlanetContent {
    static let planetContentsList: [PlanetContent] = [
        ...
        PlanetContent(planetName: "달"),
        PlanetContent(planetName: "수성"),
        PlanetContent(planetName: "금성",
        ...
        PlanetContent(planetName: "토성"),
        PlanetContent(planetName: "천왕성"),
