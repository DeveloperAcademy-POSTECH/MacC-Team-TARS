...
class InfoViewController: UIViewController {
    ...
    private var planetContentsView = CustomPlanetInfoView()
...
//    }()
    ...
    override func viewDidLoad() {
        ...
        [sceneView, planetContentsView].forEach { view.addSubview($0) }
    ...
    private func configureConstraints() {
        ...
        planetContentsView.anchor(top: sceneView.bottomAnchor, paddingTop: screenHeight / 21.1, paddingLeading: screenWidth / 12.18)
    }
}
