...
private extension UniverseMainViewController {
    ...
    private func setUpBodiesBinding() {
        ...
        universeLocationViewModel.$showErrorAlert
...
//            try await Task.sleep(nanoseconds: 5_000_000_000)
    ...
    func showErrorMessage() {
        let alert = UIAlertController(title: "API 호출 실패", message: "네트워크 연결을 확인해주세요.", preferredStyle: .alert)
